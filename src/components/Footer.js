    ...
    return (
        <div className="mt-4 flex justify-between text-xs text-gray-500">
            ...
            <ul className="flex space-x-1 items-center text-xs">
                ...
                <li className={`h-3 w-3 border-2 border-yellow-500 md:hover:bg-yellow-500 rounded-full cursor-pointer ${colors.includes('yellow') && 'bg-yellow-500'}`} onClick={() => handleColorChange('yellow')}>
                </li>
            </ul>
        </div>
    );
